...
> **Budget: ≤20 lines total** (headers excluded). Highlights, not narration. Evidence lives in commits, diffs, audits, plan files — link, don't inline. This header is the single source of truth for the budget.
