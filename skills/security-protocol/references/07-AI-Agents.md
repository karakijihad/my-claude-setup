...
> Part of [Security Protocol](../SKILL.md). Read when working with Claude Code, Codex, Cursor, MCP-enabled agents, agent teams, or any workflow where an AI reads, writes, or executes on your behalf.
