...
> Part of [Security Protocol](../SKILL.md). Read before every security-relevant commit.
...
2. Get a security review â€” `feature-dev:code-reviewer` agent with an explicit security brief, a manual review pass, or pair review. The method is flexible. The review is not.
