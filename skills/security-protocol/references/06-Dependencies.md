...
- **Run vulnerability scans regularly** â€” `npm audit`, `pip audit`, `snyk`, `trivy`, `cargo audit`, Dependabot, Renovate. Don't ignore the results. Fix or explicitly accept with documented reasoning.
...
Run `dependency-auditor` skill for any dependency changes â€” it handles vulnerability scanning, license compliance, and upgrade paths.

## AI-adjacent supply chain

MCP servers and skills are also supply chain â€” see [07-AI-Agents.md](./07-AI-Agents.md) sections 7.3 and 7.4.
